    ...
    },
    {
      ...
      options: {
        ...
        //       components: [
          ...
          //           return "<a href="+url+">"+item.properties.opa_account_num+" <i class='fa fa-arrow-up-right-from-square'></i></a>";
          //         },
          //       },
          //       {
          //         label: 'Address',
          //         value: function(state, item) {
          //           var url = window.location.origin + window.location.pathname + '#/' + item.properties.opa_account_num + '/opa'
          //           return "<a href="+url+">"+item.properties.street_address+" <i class='fa fa-arrow-up-right-from-square'></i></a>";
          //         },
          //       },
          //       {
          //         label: 'Owners',
              ...
              fields: [
                {
                  label: 'ID',
                  value: function (state, item) {
                    return "<a target='_blank' href='http://pdx-app01.city.phila.local/recorder/eagleweb/viewDoc.jsp?node=DOCC"+item.attributes.DOCUMENT_ID+"'>"+item.attributes.DOCUMENT_ID+"<i class='fa fa-arrow-up-right-from-square'></i></a>";
                    // return "<a target='_blank' href='http://pdx-app01.city.phila.local/recorder/eagleweb/viewDoc.jsp?node=DOCC"+item.attributes.R_NUM+"'>"+item.attributes.R_NUM+"<i class='fa fa-arrow-up-right-from-square'></i></a>"
                  },
                },
                {
                  label: 'Date',
